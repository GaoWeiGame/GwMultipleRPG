...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GwExperienceDefinition)

#define LOCTEXT_NAMESPACE "GwSystem"

UGwExperienceDefinition::UGwExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UGwExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UGwExperienceDefinition::UpdateAssetBundleData()
{
