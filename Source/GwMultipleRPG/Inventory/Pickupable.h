...
public:
	...
	TObjectPtr<UGwInventoryItemInstance> Item = nullptr;
};
...
public:
	...
	static void AddPickupToInventory(UGwInventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickup);
};
