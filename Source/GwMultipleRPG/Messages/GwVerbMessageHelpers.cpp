...
#include "GwVerbMessageHelpers.h"

#include "GwVerbMessage.h"
#include "GameFramework/PlayerState.h"
#include "GwMultipleRPG/AbilitySystem/GwGameplayCueManager.h"

APlayerState* UGwVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UGwVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UGwVerbMessageHelpers::VerbMessageToCueParameters(const FGwVerbMessage& Message)
{
...
FGwVerbMessage UGwVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FGwVerbMessage Result;
