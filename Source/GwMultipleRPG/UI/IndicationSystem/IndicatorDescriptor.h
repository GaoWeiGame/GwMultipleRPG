...
class UGwIndicatorManagerComponent;
class UUserWidget;
struct FFrame;
...
class GWMULTIPLERPG_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UGwIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UGwIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UGwIndicatorManagerComponent> ManagerPtr;
