...
#include "GwAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FGwAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UGwAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FGwAbilityTagRelationship> AbilityTagRelationships;
