...
#include "GwGameplayCueManager.generated.h"
...
/**
 * UGwGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UGwGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UGwGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UGwGameplayCueManager* Get();
